              ...
              <form role="form">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-4">
                    <select class="form-control select2 form-control-sm" title="Select Resellor or Admin Company">
                      <option selected="selected">Select Resellor or Admin Company</option>
                    </select>
                  </div>
