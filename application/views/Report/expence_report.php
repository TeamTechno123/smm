            ...
            <div class="card-body" >
              <form role="form">
                <div class="card-body row">
                   ...
                   <div class="form-group col-md-3">
                    <select class="form-control select2 form-control-sm" title="Select Expence Type">
                      <option selected="selected">Select Expence Type</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group col-md-2">
                    <input type="date" class="form-control form-control-sm" name="" id="" title="From Date" placeholder="To Date">
                  </div>
