              ...
              <form role="form">
                <div class="card-body row">
                   ...
                   <div class="form-group col-md-4">
                    <select class="form-control select2 form-control-sm" title="Select Projects">
                      <option selected="selected">Select Projects</option>
                    </select>
                  </div>

                  <div class="form-group col-md-4">
                    <select class="form-control select2 form-control-sm" title="Select Status">
