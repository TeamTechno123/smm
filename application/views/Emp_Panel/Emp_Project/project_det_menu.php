  ...
  <div class="card-footer p-0">
    <ul class="nav">
      <li class="nav-item <?php if($page == 'Project Overview'){ echo 'active'; } ?>" >
        <a href="<?php echo base_url(); ?>Emp_Panel/Emp_Project/project_det_overview" class="nav-link ">Overview</a>
      </li>

       <li class="nav-item <?php if($page == 'Project Progress'){ echo 'active'; } ?>">
        <a href="<?php echo base_url(); ?>Emp_Panel/Emp_Project/project_det_progress" class="nav-link">Progress </a>
      </li>

       <li class="nav-item <?php if($page == 'Project Time Log'){ echo 'active'; } ?>">
        <a href="<?php echo base_url(); ?>Emp_Panel/Emp_Project/project_det_time_log" class="nav-link">Time Log </a>
      </li>
      ...
      <li class="nav-item <?php if($page == 'Project Task'){ echo 'active'; } ?>">
        <a href="<?php echo base_url(); ?>Emp_Panel/Emp_Project/project_det_task" class="nav-link">Task</a>
      </li>
      <li class="nav-item <?php if($page == 'Project File'){ echo 'active'; } ?>">
        <a href="<?php echo base_url(); ?>Emp_Panel/Emp_Project/project_det_file" class="nav-link">File</a>
      </li>
