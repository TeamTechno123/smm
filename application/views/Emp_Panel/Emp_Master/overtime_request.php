              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <?php if(!isset($update)){
                    ...
                    echo '<a href="'.base_url().'Emp_Panel/Emp_Master/overtime_request" type="button" class="btn btn-xs btn-outline-info" >Cancel Edit</a>';
                  } ?>
                </div>
              </div>
              <!--  -->
                    ...
                    <div class="card-footer clearfix" style="display: block;">
                      <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                          <a href="<?php echo base_url(); ?>Emp_Panel/Emp_Master/overtime_request" class="btn btn-sm btn-default px-4 mx-4">Cancel</a>
                          <?php if(isset($update)){
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <?php if($list->overtime_request_status == 0){ ?>
                          <div class="btn-group">
                            <a href="<?php echo base_url() ?>Emp_Panel/Emp_Master/edit_overtime_request/<?php echo $list->overtime_request_id; ?>" type="button" class="btn btn-sm btn-default"><i class="fa fa-edit text-primary"></i></a>
                            <a href="<?php echo base_url() ?>Emp_Panel/Emp_Master/delete_overtime_request/<?php echo $list->overtime_request_id; ?>" type="button" class="btn btn-sm btn-default" onclick="return confirm('Delete this Overtime Request Information');"><i class="fa fa-trash text-danger"></i></a>
                          </div>
                        <?php } ?>
                      </td>
                      ...
                      <td><?php echo $list->overtime_request_tot_time.' Hour'; ?></td>
                      <td>
