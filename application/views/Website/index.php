...
<html lang="en">
  ...
  <body>
    ...
    <a class="navbar-brand" href="#"> <img src="<?php echo base_url(); ?>assets/images/website/logo.png"> </a>
...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="text-white text-div">
      <h1>Get Your Social Account's </h1>
      <h1>Followers And Likes At One</h1>
      <h1>Place, Instantly</h1>
      ...
      <button type="button" class="btn btn-light btn-start">Get Start Now ! </button>
    </div>
  </div>
  ...
  <div class="wave">
    <img src="<?php echo base_url(); ?>assets/images/website/wave.png" width="100%">
  </div>
    </section>
    ...
    <section class="buy-section">
      <div class="container">
        <div class="col-md-12">
        <h2 class="text-center">Buy SMM Panel in India </h2>
  ...
  <div class="card">
    ...
    <section class="working-panel">
      ...
      <div class="container">
        <div class="row">
           <div class="col-md-6">
             <h2 class="pt-3 text-white">We Will Skyrocket Your Business  in no time !</h2>
             <p class="text-white"> Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.</p>
           </div>
     ...
     <section class="working-panel2">
      <div class="container">
        <div class="row">
          <div class="col-md-12" id="minus-top">
             <h1 class="text-center">How SMM Panel Works !   </h1>
           </div>
          <div class="col-md-6">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="card">
                        <img class="card-img-top p-30" src="<?php echo base_url(); ?>assets/images/website/peter.png " alt="Card image cap">
                        <div class="card-body">
                 ...
                 <div class="col-md-6">
                    <div class="card">
                        <img class="card-img-top p-30" src="<?php echo base_url(); ?>assets/images/website/vector.png " alt="Card image cap">
                        <div class="card-body">
      ...
      <section class="footer m-center">
        <div class="container">
          <div class="row">
             <div class="col-md-3">
               <img class="bg-grey footer-menu" src="<?php echo base_url(); ?>assets/images/website/logo.png" >
               <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid</p>
               <p>Call : 9876543210</p>
               <p>email : smm@gmail.com</p>
