              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <?php if(!isset($update)){
                    ...
                    echo '<a href="'.base_url().'Timesheet/leave" type="button" class="btn btn-xs btn-outline-info" >Cancel Edit</a>';
                  } ?>
                </div>
              </div>
              <!--  -->
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          ...
                          <div class="form-group col-md-12 select_sm">
                            ...
                            <select class="form-control select2 form-control-sm" name="leave_status" id="leave_status" data-placeholder="Select Leave Status" required>
                              <option value="">Select Leave Status</option>
                              <option value="0" <?php if(isset($leave_info) && $leave_info['leave_status'] == '0'){ echo 'selected'; } ?>>Pending</option>
                              <option value="1" <?php if(isset($leave_info) && $leave_info['leave_status'] == '1'){ echo 'selected'; } ?>>Approved</option>
                              <option value="2" <?php if(isset($leave_info) && $leave_info['leave_status'] == '2'){ echo 'selected'; } ?>>Rejected</option>
                            </select>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card-footer clearfix" style="display: block;">
                      <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                          <a href="<?php echo base_url(); ?>Timesheet/leave" class="btn btn-sm btn-default px-4 mx-4">Cancel</a>
                          <?php if(isset($update)){
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          <a href="<?php echo base_url() ?>Timesheet/edit_leave/<?php echo $list->leave_id; ?>" type="button" class="btn btn-sm btn-default"><i class="fa fa-edit text-primary"></i></a>
