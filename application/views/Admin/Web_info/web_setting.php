              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <?php if(!isset($update)){
                    ...
                    echo '<a href="'.base_url().'User/dashboard" class="btn btn-sm btn-outline-info">Cancel Edit</a>';
                  } ?>
                </div>
              </div>
              <!--  -->
                ...
                <form class="input_form m-0" id="form_action" role="form" action="" method="post" enctype="multipart/form-data">
                  <div class="row p-4">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <input type="text" class="form-control form-control-sm" name="web_setting_name" id="web_setting_name" value="<?php if(isset($web_setting_info)){ echo $web_setting_info['web_setting_name']; } ?>"  placeholder="Enter Name of Company" required >
                    </div>
                    <div class="form-group col-md-12">
                      <label>Address</label>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="email" class="form-control form-control-sm email" name="web_setting_email" id="web_setting_email" value="<?php if(isset($web_setting_info)){ echo $web_setting_info['web_setting_email']; } ?>" placeholder="Email" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label>Website</label>
                      <input type="text" class="form-control form-control-sm website" name="web_setting_website" id="web_setting_website" value="<?php if(isset($web_setting_info)){ echo $web_setting_info['web_setting_website']; } ?>" placeholder="Website">
                    </div>
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="file" class="form-control form-control-sm valid_image" name="web_setting_logo" id="web_setting_logo">
                    ...
                    <div class="form-group col-md-3">
                      <?php if(isset($web_setting_info) && $web_setting_info['web_setting_logo']){ ?>
                        ...
                        <img width="150px" src="<?php echo base_url(); ?>assets/images/master/<?php echo $web_setting_info['web_setting_logo']; ?>" alt="">
                      <?php } ?>
                    </div>

                    <div class="form-group col-md-3">
                      <label>Website Fevicon</label>
                      <input type="file" class="form-control form-control-sm valid_image" name="web_setting_favicon" id="web_setting_favicon">
                      <label>Select .jpg/.png/.jpeg file. size is less than 500kb</label>
                    </div>
                    <div class="form-group col-md-3">
                      <?php if(isset($web_setting_info) && $web_setting_info['web_setting_favicon']){ ?>
                        ...
                        <img width="150px" src="<?php echo base_url(); ?>assets/images/master/<?php echo $web_setting_info['web_setting_favicon']; ?>" alt="">
                      <?php } ?>
                    </div>

                    <div class="form-group col-md-12">
                      <label>About Us Information</label>
                      <textarea class="textarea form-control form-control-sm" rows="3" name="web_setting_about_info" id="web_setting_about_info" placeholder="Enter Company Address" required><?php if(isset($web_setting_info)){ echo $web_setting_info['web_setting_about_info']; } ?></textarea>
                    </div>

                    <div class="form-group col-md-12">
                      <label>Contact Us Information</label>
                      <textarea class="textarea form-control form-control-sm" rows="3" name="web_setting_contact_info" id="web_setting_contact_info" placeholder="Enter Company Address" required><?php if(isset($web_setting_info)){ echo $web_setting_info['web_setting_contact_info']; } ?></textarea>
                    </div>
