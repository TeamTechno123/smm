              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <?php if(!isset($update)){
                    ...
                    echo '<a href="'.base_url().'Web_info/blog" type="button" class="btn btn-sm btn-outline-info" >Cancel Edit</a>';
                  } ?>
                </div>
              </div>
              <!--  -->
                  ...
                  <form class="input_form m-0 needs-validation" novalidate id="form_action" role="form" action="" method="post" autocomplete="off" enctype="multipart/form-data">
                    <div class="row p-4">
                      <div class="form-group col-md-4 select_sm">
                        ...
                        <select class="form-control select2" name="blog_category_id" id="blog_category_id" data-placeholder="Select Category" required >
                          <option value="">Select Category</option>
                          <?php if(isset($blog_category_list)){ foreach ($blog_category_list as $list) { ?>
                          <option value="<?php echo $list->blog_category_id; ?>" <?php if(isset($blog_info) && $blog_info['blog_category_id'] == $list->blog_category_id){ echo 'selected'; } if($list->blog_category_status == 0){ echo ' disabled'; } ?>><?php echo $list->blog_category_name; ?></option>
                          <?php } } ?>
                        </select>
                      </div>
                    ...
                    <div class="card-footer clearfix" style="display: block;">
                      <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                          <a href="<?php echo base_url(); ?>Web_info/blog" class="btn btn-sm btn-default px-4 mx-4">Cancel</a>
                          <?php if(isset($update)){
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          <a href="<?php echo base_url() ?>Web_info/edit_blog/<?php echo $list->blog_id; ?>" type="button" class="btn btn-sm btn-default"><i class="fa fa-edit text-primary"></i></a>
                          <a href="<?php echo base_url() ?>Web_info/delete_blog/<?php echo $list->blog_id; ?>" type="button" class="btn btn-sm btn-default" onclick="return confirm('Delete this Blog Information');"><i class="fa fa-trash text-danger"></i></a>
                        </div>
                      </td>
