              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <?php if(!isset($update)){
                    ...
                    echo '<a href="'.base_url().'Web_info/slider" type="button" class="btn btn-sm btn-outline-info" >Cancel Edit</a>';
                  } ?>
                </div>
              </div>
              <!--  -->
                  ...
                  <form class="input_form m-0" id="form_action" role="form" action="" method="post" autocomplete="off" enctype="multipart/form-data">
                    <div class="row p-4">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <input type="file" class="form-control form-control-sm" name="slider_image" id="slider_image" >
                    ...
                    <div class="card-footer clearfix" style="display: block;">
                      <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                          <a href="<?php echo base_url(); ?>Web_info/slider" class="btn btn-sm btn-default px-4 mx-4">Cancel</a>
                          <?php if(isset($update)){
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          <a href="<?php echo base_url() ?>Web_info/edit_slider/<?php echo $list->slider_id; ?>" type="button" class="btn btn-sm btn-default"><i class="fa fa-edit text-primary"></i></a>
                          <a href="<?php echo base_url() ?>Web_info/delete_slider/<?php echo $list->slider_id; ?>" type="button" class="btn btn-sm btn-default" onclick="return confirm('Delete this Slider Information');"><i class="fa fa-trash text-danger"></i></a>
                        </div>
                      </td>
