              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <?php if(!isset($update)){
                    ...
                    echo '<a href="'.base_url().'Project/project_revision" class="btn btn-xs btn-outline-info">Cancel Edit</a>';
                  } ?>
                </div>
              </div>
                ...
                <form class="input_form m-0" id="form_action" role="form" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-footer clearfix" style="display: block;">
                    <div class="row">
                      ...
                      <div class="col-md-6 text-right">
                        <a href="<?php echo base_url(); ?>Project/project_revision" class="btn btn-sm btn-default px-4 mx-4">Cancel</a>
                        <?php if(isset($update)){
...
<script type="text/javascript">
  ...
  $('#myTable').on('click', '.rem_row', function () {
    ...
    $.ajax({
      url:'<?php echo base_url(); ?>Project/delete_project_revision_file',
      type: 'POST',
