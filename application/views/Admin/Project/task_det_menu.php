  ...
  <div class="card-footer p-0">
    <ul class="nav">
      <li class="nav-item <?php if($page == 'Task Overview'){ echo 'active'; } ?>" >
        <a href="<?php echo base_url(); ?>Project/task_det_overview" class="nav-link ">Overview</a>
      </li>
       <li class="nav-item <?php if($page == 'Task Progress'){ echo 'active'; } ?>">
        <a href="<?php echo base_url(); ?>Project/task_det_progress" class="nav-link">Progress </a>
      </li>
      <li class="nav-item <?php if($page == 'Task File'){ echo 'active'; } ?>">
        <a href="<?php echo base_url(); ?>Project/task_det_file" class="nav-link">File</a>
      </li>
