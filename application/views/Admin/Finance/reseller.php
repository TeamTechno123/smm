              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <?php if(!isset($update)){
                    ...
                    echo '<a href="<?php base_url(); ?>Finance/reseller" class="btn btn-sm btn-outline-info">Cancel Edit</a>';
                  } ?>
                </div>
              </div>
              <!--  -->
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a href="<?php echo base_url() ?>Finance/edit_reseller/<?php echo $list->reseller_id; ?>" type="button" class="btn btn-sm btn-default"><i class="fa fa-edit text-primary"></i></a>
                            <a href="<?php echo base_url() ?>Finance/delete_reseller/<?php echo $list->reseller_id; ?>" type="button" class="btn btn-sm btn-default" onclick="return confirm('Delete this Reseller');"><i class="fa fa-trash text-danger"></i></a>
                          </div>
                        </td>
