                ...
                <form class="input_form m-0" id="form_action" role="form" action="" method="post">
                  <div class="row p-4">
                    ...
                    <div class="form-group col-md-9 select_sm">
                      ...
                      <input type="text" class="form-control form-control-sm" name="unit_code" id="unit_code" value="<?php if(isset($unit_info)){ echo $unit_info['unit_code']; } ?>"  placeholder="Enter Unit Code" required >
                    </div>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-md-6 text-left">
                        <div class="custom-control custom-checkbox">
                          ...
                          <label for="unit_status" class="custom-control-label no_bold">Disable This Unit</label>
                        </div>
                      </div>
                      <div class="col-md-6 text-right">
                        <a href="<?php echo base_url(); ?>Product/unit" class="btn btn-sm btn-default px-4 mx-4">Cancel</a>
                        <?php if(isset($update)){
                  ...
                  <tbody>
                    <?php if(isset($unit_list)){
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a href="<?php echo base_url() ?>Product/edit_unit/<?php echo $list->unit_id; ?>" type="button" class="btn btn-sm btn-default"><i class="fa fa-edit text-primary"></i></a>
                            <a href="<?php echo base_url() ?>Product/delete_unit/<?php echo $list->unit_id; ?>" type="button" class="btn btn-sm btn-default" onclick="return confirm('Delete this Unit');"><i class="fa fa-trash text-danger"></i></a>
                          </div>
                        </td>
