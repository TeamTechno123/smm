                        ...
                        <div class="row">
                          <div class="form-group col-md-12 select_sm">
                            ...
                            <select class="form-control select2 form-control-sm" name="employee_id" id="employee_id" data-placeholder="Select Employee" required>
                              ...
                              <option value="<?php echo $list->employee_id; ?>" <?php if(isset($transfer_info) && $transfer_info['employee_id'] == $list->employee_id){ echo 'selected'; } if($list->employee_status == '0'){ echo 'disabled'; } ?>><?php echo $list->employee_name.' '.$list->employee_lname; ?></option>
                              <?php } } ?>
                            </select>
                          </div>
