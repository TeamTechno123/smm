              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <?php if(!isset($update)){
                    ...
                    echo '<a href="'.base_url().'Master/web_setup_request" type="button" class="btn btn-sm btn-outline-info" >Cancel Edit</a>';
                  } ?>
                </div>
              </div>
              <!--  -->
                  ...
                  <form class="input_form m-0 needs-validation" novalidate id="form_action" role="form" action="" method="post" autocomplete="off" enctype="multipart/form-data">
                    <div class="row p-4">
                      <div class="form-group col-md-6 ">
                        ...
                        <input type="number" min="1" step="1" class="form-control form-control-sm" name="web_setup_request_no" id="web_setup_request_no" value="<?php if(isset($web_setup_request_info)){ echo $web_setup_request_info['web_setup_request_no']; } ?>" required disabled>
                      </div>
                      <div class="form-group col-md-6">
                        <label>Request Date</label>
                        <input type="text" class="form-control form-control-sm" name="web_setup_request_date" value="<?php if(isset($web_setup_request_info)){ echo $web_setup_request_info['web_setup_request_date']; } else{ echo date('d-m-Y'); } ?>" required disabled>
                      </div>
                      <div class="form-group col-md-12 select_sm">
                        <label>Type</label>
                        <br>
                        <span><?php if(isset($web_setup_request_info) && $web_setup_request_info['web_setup_request_type'] == '1'){ echo 'Setting up my website'; } ?></span>
                        <!-- <select class="form-control select2" name="web_setup_request_type" id="web_setup_request_type" data-placeholder="Select Type" required disabled>
                      ...
                      <div class="form-group col-md-12 ">
                        ...
                        <span>
                          <?php if(isset($web_setup_request_info)){ echo $web_setup_request_info['web_setup_request_descr']; } ?>
                        </span>
                      ...
                      <div class="form-group col-md-4 select_sm">
                        <label>Status</label>
                        <select class="form-control select2" name="web_setup_request_status" id="web_setup_request_status" data-placeholder="Select Status" required >
                          <option value="">Select Status</option>
                          <option value="0" <?php if(isset($web_setup_request_info) && $web_setup_request_info['web_setup_request_status'] == '0'){ echo 'selected'; } ?>>Pending</option>
                          <option value="1" <?php if(isset($web_setup_request_info) && $web_setup_request_info['web_setup_request_status'] == '1'){ echo 'selected'; } ?>>Complete</option>
                        </select>
                      </div>
                    ...
                    <div class="card-footer clearfix" style="display: block;">
                      <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                          <a href="<?php echo base_url(); ?>Master/web_setup_request" class="btn btn-sm btn-default px-4 mx-4">Cancel</a>
                          <?php if(isset($update)){
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          <a href="<?php echo base_url() ?>Master/edit_web_setup_request/<?php echo $list->web_setup_request_id; ?>" type="button" class="btn btn-sm btn-default"><i class="fa fa-edit text-primary"></i></a>
                          <!-- <a href="<?php echo base_url() ?>Master/delete_web_setup_request/<?php echo $list->web_setup_request_id; ?>" type="button" class="btn btn-sm btn-default" onclick="return confirm('Delete this Web Setup Request Information');"><i class="fa fa-trash text-danger"></i></a> -->
                        </div>
                      </td>
