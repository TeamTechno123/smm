        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12">
                <img src="<?php echo base_url() ?>assets/images/package/<?php echo $package_details['package_image'];  ?>" class="product-image" alt="Product Image">
              </div>
            </div>
            <div class="col-12 col-sm-6">
          ...
          <div class="row mt-4">
            <?php foreach ($package_feature_list as $package_feature_list2) { ?>
              <div class="col-md-4">
                <div class="card p-2">
                  <img src="<?php echo base_url() ?>assets/images/package/<?php echo $package_feature_list2->package_feature_image;  ?>" class="product-image" alt="Product Image">
