        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card-body text-center bg-info">
              ...
              <div class="widget-user-header" style="background: url('<?php echo base_url() ?>assets/images/package/<?php echo $list->package_image;  ?>'); background-size: cover;">
              </div>
              <!-- <div class="widget-user-image">
                <img style="height:90px !important;" class="img-circle elevation-2" src="<?php echo base_url() ?>assets/images/package/<?php echo $list->package_image;  ?>" alt="User Avatar">
              </div> -->
