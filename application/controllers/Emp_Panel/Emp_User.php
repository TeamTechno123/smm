...
class Emp_User extends CI_Controller{
  ...
  public function logout(){
    ...
    $this->session->unset_userdata('smm_emp_id');
    $this->session->unset_userdata('smm_emp_company_id');
...
/**************************      Login      ********************************/
  ...
  public function index(){
    ...
    if($smm_emp_id == '' || $smm_emp_company_id == ''){
      $this->form_validation->set_rules('mobile', 'Mobile No', 'trim|required');
      $this->form_validation->set_rules('password', 'Password', 'trim|required');
      if ($this->form_validation->run() == FALSE) {
      	$this->load->view('Emp_Panel/Emp_User/login');
      } else{
  ...
  public function forgot_password(){
    $this->load->view('Employee/Emp_User/forgot_password');
  }
...
/**************************      Dashboard      ********************************/
  public function dashboard(){
    ...
    $this->load->view('Emp_Panel/Emp_User/dashboard', $data);
...
/************************************* Profile **************************************/
  public function profile(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      header('location:'.base_url().'Employee/Emp_User/profile');
    }

    $reseller_info = $this->Master_Model->get_info_arr('reseller_id',$smm_emp_id,'smm_reseller');
    if(!$reseller_info){ header('location:'.base_url().'Employee/Emp_User/dashboard'); }
    $data['update'] = 'update';
    $data['update_reseller'] = 'update';
    $data['reseller_info'] = $reseller_info[0];
    // $data['act_link'] = base_url().'Res_User/edit_reseller/'.$smm_emp_id;
    ...
    $this->load->view('Employee/Emp_User/profile', $data);
...
/*******************************    User Information      ****************************/
  ...
  public function user_information(){
    ...
    if($smm_emp_id == '' || $smm_emp_company_id == ''){ header('location:'.base_url().'User'); }
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['user_addedby'] = $smm_emp_id;
    ...
    $data['role_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'','','','','','','role_id','ASC','role');
    $data['branch_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'','','','','','','branch_name','ASC','smm_branch');
    $data['designation_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'','','','','','','designation_name','ASC','smm_designation');
    $data['department_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'','','','','','','department_name','ASC','smm_department');
    $data['office_shift_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'','','','','','','office_shift_name','ASC','smm_office_shift');
    $data['user_report_to_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'','','','','','','user_name','ASC','user');
    $data['leave_type_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'','','','','','','leave_type_name','ASC','smm_leave_type');

    $data['user_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'is_admin','0','','','','','user_id','ASC','user');
    $data['page'] = 'User';
  ...
  public function edit_user($user_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['user_addedby'] = $smm_emp_id;
...
/*******************************    Role Information      ****************************/
  ...
  public function role(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['company_id'] = $smm_emp_company_id;
      $save_data['role_addedby'] = $smm_emp_id;
  ...
  public function edit_role($role_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['role_addedby'] = $smm_emp_id;
