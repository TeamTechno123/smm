...
/**************************      Timesheet      ********************************/
  ...
  public function ticket(){
    ...
    // $data['project_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'','','','','','','project_id','ASC','smm_project');
    $data['page'] = 'Employee Ticket';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/ticket', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function basic_info(){
    ...
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/basic_info', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function salary(){
    ...
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/salary', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function contact(){
    ...
    // $data['project_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'','','','','','','project_id','ASC','smm_project');
    $data['page'] = 'Employee Contact Information';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/contact', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function social(){
    ...
    $data['page'] = ' Social Information';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/social', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function documents(){
    ...
    $data['page'] = ' Documents Information';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/documents', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function qualification(){
    ...
    $data['page'] = ' Qualification Information';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/qualification', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function experience(){
    ...
    $data['page'] = ' Experience Information';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/experience', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function bank(){
    ...
    $data['page'] = ' Bank Information';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/bank', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function change_password(){
    ...
    $data['page'] = 'Change Password Information';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/change_password', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function progress(){
    ...
    $data['page'] = 'Progress Information';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/progress', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function timelog(){
    ...
    $data['page'] = 'Timelog Information';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/timelog', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function overview(){
    ...
    $data['page'] = 'Overview Information';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/overview', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function file(){
    ...
    $data['page'] = 'File Information';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/file', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function note(){
    ...
    $data['page'] = 'Note Information';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/note', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
  ...
  public function bug(){
    ...
    $data['page'] = 'Bug Information';
    $this->load->view('Emp_Panel/Include/head', $data);
    $this->load->view('Emp_Panel/Include/navbar', $data);
    $this->load->view('Emp_Panel/Emp_Master/bug', $data);
    $this->load->view('Emp_Panel/Include/footer', $data);
  }
...
/********************************* Reseller ***********************************/
  ...
  public function reseller(){
    $smm_emp_id = $this->session->userdata('smm_emp_id');
    $smm_emp_company_id = $this->session->userdata('smm_emp_company_id');
    if($smm_emp_id == '' || $smm_emp_company_id == ''){ header('location:'.base_url().'Reseller/Res_User'); }
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['reseller_addedby'] = $smm_emp_id;
    ...
    // $data['branch_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'','','','','','','branch_name','ASC','smm_branch');

    $data['reseller_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'reseller_added_type','2','reseller_addedby',$smm_emp_id,'','','reseller_id','DESC','smm_reseller');
    $data['page'] = 'Reseller';
...
/*********************************** Slider *********************************/
  ...
  public function slider(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['slider_addedby'] = $smm_emp_id;
    ...
    $data['slider_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'slider_addedby_type','2','slider_addedby',$smm_emp_id,'','','slider_id','DESC','smm_slider');
    $data['page'] = 'Slider';
    $this->load->view('Reseller/Include/head', $data);
    $this->load->view('Reseller/Include/navbar', $data);
...
/*********************************** Testimonial *********************************/
  ...
  public function testimonial(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['testimonial_addedby'] = $smm_emp_id;
    ...
    $data['testimonial_no'] = $this->Master_Model->get_count_no($smm_emp_company_id, 'testimonial_no', 'smm_testimonial');

    $data['testimonial_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'testimonial_addedby_type','2','testimonial_addedby',$smm_emp_id,'','','testimonial_id','DESC','smm_testimonial');
...
/************************************* Web Setting **************************************/
  public function web_setting(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $this->Master_Model->update_info('reseller_id', $smm_emp_id, 'smm_web_setting', $update_data);

      if($_FILES['web_setting_logo']['name']){
        $time = time();
        $image_name = 'web_setting_logo'.$smm_emp_id.'_'.$time;
        ...
        $ext = pathinfo($filename, PATHINFO_EXTENSION);
        $this->upload->initialize($config); // if upload library autoloaded
        if ($this->upload->do_upload('web_setting_logo') && $smm_emp_id && $image_name && $ext && $filename){
          $web_setting_logo_up['web_setting_logo'] =  $image_name.'.'.$ext;
          $this->Master_Model->update_info('reseller_id', $smm_emp_id, 'smm_web_setting', $web_setting_logo_up);
      ...
      if($_FILES['web_setting_favicon']['name']){
        $time = time();
        $image_name = 'web_setting_favicon'.$smm_emp_id.'_'.$time;
        $config['upload_path'] = 'assets/images/web_setting/';
        $config['allowed_types'] = 'jpg|jpeg|png|gif';
        $config['file_name'] = $image_name;
        ...
        $ext = pathinfo($filename, PATHINFO_EXTENSION);
        $this->upload->initialize($config); // if upload library autoloaded
        if ($this->upload->do_upload('web_setting_favicon') && $smm_emp_id && $image_name && $ext && $filename){
          $web_setting_favicon_up['web_setting_favicon'] =  $image_name.'.'.$ext;
          $this->Master_Model->update_info('reseller_id', $smm_emp_id, 'smm_web_setting', $web_setting_favicon_up);
    ...
    $web_setting_info = $this->Master_Model->get_info_arr('reseller_id',$smm_emp_id,'smm_web_setting');
    ...
    // $data['act_link'] = base_url().'Res_Master/edit_web_setting/'.$smm_emp_id;
...
/*********************************** Announcement *********************************/
  ...
  public function announcement(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['announcement_addedby'] = $smm_emp_id;
    ...
    $data['branch_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'','','','','','','branch_name','ASC','smm_branch');
    $data['department_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'','','','','','','department_name','ASC','smm_department');

    $data['announcement_list'] = $this->Master_Model->get_list_by_id3($smm_emp_company_id,'announcement_addedby_type','2','announcement_addedby',$smm_emp_id,'','','announcement_id','DESC','smm_announcement');
