...
class User extends CI_Controller{
  ...
  public function logout(){
    ...
    $this->session->unset_userdata('smm_user_id');
    ...
    if($smm_user_id == '' || $smm_company_id == ''){
      ...
      if ($this->form_validation->run() == FALSE) {
        ...
        if($login == null){
          ...
          $role_info = $this->Master_Model->get_info_arr_fields('role_permission','role_id', $login[0]['role_id'], 'role');
          $role_permission = $role_info[0]['role_permission'];
          $role_permission_arr = explode(',', $role_permission);
          $this->session->set_userdata('smm_user_id', $login[0]['user_id']);
...
/*******************************    User Information      ****************************/
  ...
  public function user_information(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['user_addedby'] = $smm_user_id;
    ...
    $data['user_report_to_list'] = $this->Master_Model->get_list_by_id3($smm_company_id,'','','','','','','user_name','ASC','user');
  ...
  public function edit_user($user_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['user_addedby'] = $smm_user_id;
...
/*******************************    Role Information      ****************************/
  ...
  public function role(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['company_id'] = $smm_company_id;
      $save_data['role_addedby'] = $smm_user_id;
  ...
  public function edit_role($role_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['role_addedby'] = $smm_user_id;
